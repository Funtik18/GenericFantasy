...
public class EntityStats
{
	...
	//	HP.BaseValue = Mathf.Floor(38 + (Level.Value * 12) + ((float)Strength.StatCurrentValue / 2));
	//	MP.BaseValue = Mathf.Floor(40 + (Level.Value * 6) + ((float)Intelligence.StatCurrentValue / 2));
	////}
	#endregion
